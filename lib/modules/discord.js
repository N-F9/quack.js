...
var Discord = {
    ...
    Prompt: function (message, member, options) {
        return new Promise(function (resolve, reject) {
            if (options.type === 'message') {
                ...
                message.channel.awaitMessages(filter, { max: 1 }).then(function (collected) {
                ...
                message.awaitReactions(filter, { max: 1 }).then(function (collected) {
                    var c = collected.first();
                    resolve(c);
                });
            }
    ...
    DeleteChannel: function (guild, finder) {
        ...
        guild.channels.cache
            .find(function (c) { return (c.name === finder || c.id === finder) && c.type === 'text'; })
            .delete();
    },
