...
const Utils = {
    ...
    Error(e) {
        ...
        (() => __awaiter(this, void 0, void 0, function* () { return (0, log_1.Log)((yield (0, locale_1.default)()).utils.errors.error, 'e'); }))();
    },
    GetFiles(directory) {
    ...
    Backup(file) {
        ...
        fs.copyFile(file, `./backups/${time.year}-${time.month}-${time.date}-${file}`, (err) => {
            ...
            (() => __awaiter(this, void 0, void 0, function* () { return (0, log_1.Log)((yield (0, locale_1.default)()).utils.success.backup.replace(/{file}/g, file), 's'); }))();
        });
    },
    MS: ms_1.default,
};
