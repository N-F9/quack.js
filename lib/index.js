...
const variables_1 = __importDefault(require("./handlers/variables"));
console.log(variables_1.default);
exports.QuackJSUtils = Object.assign(Object.assign({}, utils_1.default), { Log: log_1.Log,
    Debug: log_1.Debug,
...
class QuackJS {
    constructor(token, config) {
        ...
        if (typeof config.database === 'boolean') {
            if (config.database)
                this.sequelize = new sequelize_1.Sequelize(defaultDatabase);
            else
                this.sequelize = undefined;
        }
        else
            this.sequelize = new sequelize_1.Sequelize(config.database || defaultDatabase);
        this.models = {};
    ...
    Start(QuackJS) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
                ...
                execute(client) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (new Set(commandsNames).size !== commandsNames.length)
                            (0, log_1.Log)((yield (0, locale_1.default)()).commands.errors.names, 'w');
            ...
            try {
                (_a = this.sequelize) === null || _a === void 0 ? void 0 : _a.authenticate();
            }
            catch (error) {
    ...
    AddModel(name, model) {
        ...
        (_a = this.sequelize) === null || _a === void 0 ? void 0 : _a.sync();
    }
