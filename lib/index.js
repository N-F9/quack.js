                        ...
                        this.CreateEvent({
                            ...
                            execute: function (client, message) {
                                ...
                                if (message.content.startsWith(QuackJS.config.prefix)) {
                                    ...
                                    // check this command.permission
                                    if (command_1)
                                        if (command_1.permission === 'everyone')
                                            command_1.execute(client, message, args);
                                        else if ((_a = message.member) === null || _a === void 0 ? void 0 : _a.roles.cache.array().some(function (role) { return role.id == command_1.permission || role.name == command_1.permission; }))
                                            command_1.execute(client, message, args);
                                    return;
                                }
                            },
