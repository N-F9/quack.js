...
exports.QuackJSUtils = __assign(__assign({}, utils_1.default), { YAML: yaml_1.default, Log: log_1.default });
                        ...
                        this.CreateEvent({
                            ...
                            execute: function (client, message) {
                                if (message.author.bot)
                                    return;
                                if (message.content.startsWith(QuackJS.config.prefix) || message.author.bot) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        if (Object.values(_this.config.configs).length === Object.values(_this.configs).length)
