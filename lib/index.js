                                ...
                                if (message.content.startsWith(QuackJS.config.prefix)) {
                                    ...
                                    var parseArgs = function (ar) {
                                        return ar.map(function (arg) {
                                            ...
                                            var num = exports.QuackJSUtils.Validator('Number', arg) && new Number(arg);
                                    ...
                                    var args = QuackJS.config.doubleQuoteArgs
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var getAllFiles = function (dirPath, arrayOfFiles) {
                            var files = fs.readdirSync(path.join(process.env.PWD, dirPath, '/'));
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, _reject) {
                        QuackJS.files
                            ...
                            .forEach(function (file, index) { return __awaiter(_this, void 0, void 0, function () {
                            var name, module, _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
